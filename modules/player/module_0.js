...
(function($) {
    ...
    $.fn.audioplayer = function(o) {
        var defaults = {
            ...
            ,cue: 'off' // this chooses wheter "on" or not "off" a part .. what part is decided by the preload_method below
            ,preload_method: 'auto' // -- "none" or "metadata" or "auto" ( whole track )
            ...
            ,
            playfrom: 'last' //off //off or specific number of settings or set to "last"
            ,
            ...
            , design_wave_color_progress: 'f508ea' //#f497d9// -- waveform progress color
        ...
        this.each(function() {
            ...
            var last_vol = 1,
                ...
                the_player_id = ''
                ,pcm_identifier = '0'// -- can be either player id or source if player id is not set
                ;
            ...
            if(o.skinwave_preloader_code=='default'){
                ...
                o.skinwave_preloader_code = ' <svg class="loading-svg" width="30" height="30" viewBox="0 0 44 44" xmlns="http://www.w3.org/2000/svg" stroke="#fff"><g fill="none" fill-rule="evenodd" stroke-width="2"> <circle cx="22" cy="22" r="1"> </circle> <circle cx="22" cy="22" r="1"> </circle></g> </svg>';
            ...
            function init() {
                ...
                //pcm_identifier = the_player_id; // -- the pcm identifier to send via ajax _Я ЗАКОМ
                ...
                if (_feed_obj) {
                    ...
                    if (_feed_obj.attr('data-playerid')) {
                        ...
                        //pcm_identifier = _feed_obj.attr('data-playerid'); Я_КОМ
                    } else {

                        if (_feed_obj.attr('data-source')) {

                           // pcm_identifier = _feed_obj.attr('data-source'); Я КОМ
                        }
                    }
                }
                        ...
                        ,success: function (response) {
                            ...
                            try {
                                ...
                                if (cthis.attr('data-pcm')) {
                                    ...
                                    pcm_is_real = false;//Я ИЗМЕНИЛ true
                                }
                                if (o.design_skin == 'skin-wave'){
...
//                            console.info(auxa);
            ...
            function change_media(arg, pargs) {
                ...
                if (margs.fakeplayer_is_feeder == 'on') {
                    ...
                    if(_feed_fakePlayer.attr('data-pcm')){
                        //margs.pcm = _feed_fakePlayer.attr('data-pcm'); Я_КОМ
                    }
                ...
                if(_feed_fakeButton){
                    ...
                    if(_c.attr('data-pcm')){
                        //margs.pcm = _c.attr('data-pcm'); Я_КОМ
                    }
                ...
                if (o.design_skin == 'skin-wave' && skinwave_mode == 'small' && o.change_media_animate_skinwave_mode_small=='on') {
                    ...
                    if (o.skinwave_wave_mode == 'canvas') {
                        ...
                        if (margs.pcm) {
                           ...
                           // cthis.attr('data-pcm', _arg.attr('data-pcm')); Я_КОМ
                        } else {
                            // console.info("HMMM canvas")
                    ...
                    if(o.design_skin=='skin-wave'){
                        if (o.skinwave_wave_mode == 'canvas') {
                            ...
                            if (margs.pcm!='') {
                               ...
                               // cthis.attr('data-pcm', margs.pcm); Я_КОМ
                            } else {
                            ...
                            success: function(response) {
                                ...
                                if(response){
                                    ...
                                    if(response!='0' && response.indexOf(',')>-1){
                                       ...
                                       // cthis.attr('data-pcm', response); Я_КОМ
                                        pcm_is_real=false; //Я_ИЗМЕНИЛ true
                                        ...
                                        pcm_try_to_generate=false; //Я_ИЗМЕНИЛ true
                                    }
            ...
            function generate_wave_data(pargs) {
                ...
                if(window.dzsap_generating_pcm ){
                    setTimeout(function(){
                       // generate_wave_data(margs)//Я_ИЗМЕНИЛ 
                    },1000);
                ...
                window.dzsap_generating_pcm = false; //Я_ИЗМЕНИЛ true
              ...
              //  console.info(' src_real_mp3 - '+src_real_mp3, src_real_mp3);
                ...
                function send_pcm(ar_str){
                   ...
                   // cthis.attr('data-pcm', ar_str);//Я_ИЗМЕНИЛ true
                    if (_feed_fakeButton && _feed_fakeButton.attr) {
                       // _feed_fakeButton.attr('data-pcm', ar_str);//Я_ИЗМЕНИЛ true
                    }
                ...
                wavesurfer.on('error', function() {
                    ...
                    var default_pcm = [];
/*
                    for (var i3 = 0; i3 < 1000; i3++) {//Я_ИЗМЕНИЛ 
                    ...
                    if (o.skinwave_enableSpectrum != 'on') {
                        ...
                        if (o.skinwave_wave_mode == 'canvas') {
                            ...
                            if (cthis.attr('data-pcm')) {
                                ...
                                pcm_is_real = true;//Я_ИЗМЕНИЛ true
                                setup_structure_scrub_canvas();
                                ...
                                cthis.attr('data-pcm', default_pcm); //ВОТ ГДЕ ЗАДАЕТСЯ МОЙ PCM по нему строится canvas
