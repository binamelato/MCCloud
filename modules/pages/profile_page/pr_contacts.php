...
if($a_ma == ''/*$a_domain == '' and $a_telega == '' and $a_fbook == '' and $a_twit == '' and $a_mail == '' and $a_ytube == '' and $a_inst == '' and $a_vk == ''*/){
/*echo"
<div class='med_i_for'>
	<div class='like_li'>
...
<div class='med_i_for'>
	<div class='like_li'>
		<img class='sagi' src='http://".$_SERVER['HTTP_HOST']."/content/sys/user_b.png'>
		<span style='vertical-align:top;'>Contacts</span>			
		<a class='li_modu'><span style='vertical-align:top;float:right;'></span></a>
	</div>
	<div class='like_pho'>
