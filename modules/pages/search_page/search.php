<?
$querlj = mysqli_query($link, "SELECT 1 FROM o_track WHERE o_group = '{$dot1}' and `type_dost`='1'");
if($querlj){
echo"
<div id='header' class='_t'>
	...
	<tr><td>#</td><td>Tracks</td></tr>
		...
		<ul class='muz'>";
	$query77 = mysqli_query($link, "SELECT * FROM o_track WHERE o_group = '{$dot1}' and `type_dost`='1' ORDER BY id DESC");
